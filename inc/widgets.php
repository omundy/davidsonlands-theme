...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
			'name'          => __( 'Footer Fluid', 'understrap' ),
			'id'            => 'footerfluid',
			'description'   => __( 'Fluid width footer widget with dynamic grid', 'understrap' ),
			'before_widget'  => '<div id="%1$s" class="footer-widget %2$s '. understrap_slbd_count_widgets( 'footerfluid' ) .'">',
