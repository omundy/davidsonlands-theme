       ...
       <div class="row">
        ...
        <div class="row">
            <div class="col-sm-3 col-xs-6 text-center mt-4">
				<a class="link-on-light-bg" href="<?php echo home_url(); ?>/programming/education-and-outreach">
            ...
            <div class="col-sm-3 col-xs-6 text-center mt-4">
				<a class="link-on-light-bg" href="<?php echo home_url(); ?>/programming/communications/">
	                <div class="circle-callout-image">
